"""
Django settings for aged_union_38546 project.
...
ROOT_URLCONF = 'aged_union_38546.urls'
...
WSGI_APPLICATION = 'aged_union_38546.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "aged_union_38546 API",
    "DESCRIPTION": "API documentation for aged_union_38546 App",
    "VERSION": "v1",
}
